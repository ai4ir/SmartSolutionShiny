...
extractCatVarName <- function(df) {
 ...
 # df <- dfReportCommon
aesList[["y"]] <- setdiff(aesList[["y"]], 
                          c(aesList[["x"]], aesList[["size"]], aesList[["shape"]]))
x <- df[,aesList[["x"]]]
# x <- df[,"wt"]
dfY <- df[,aesList[["y"]]]

calcR2Fit1 <- function(y) {
...
switch(aesList[["fitOption"]],
       NoFit = {},
       Fit1 = {
         R2Vec <- vapply(dfY, calcR2Fit1, numeric(1))
       },
       Fit2 = {
         R2Vec <- vapply(dfY, calcR2Fit2, numeric(1))
       },
       {}
)
if(aesList[["fitOption"]]!="NoFit") {
  ...
  aesList[["y"]] <- row.names(meltR)[orderR]
}
...
renderScatterPlotSet <- function(yVarNo) {
gg1 <- NULL; gg2 <- NULL; gg3 <- NULL; gg4 <- NULL;
if(!is.na(x=aesList[["y"]][yVarNo]))
  gg1 <- renderScatterPlot(x=aesList[["x"]], y=aesList[["y"]][yVarNo], color=aesList[["color"]],
                    size=aesList[["size"]], shape=aesList[["shape"]], tooltip=aesList[["tooltip"]],
                    data_id=aesList[["data_id"]])
if(!is.na(x=aesList[["y"]][yVarNo+1]))
  gg2 <- renderScatterPlot(x=aesList[["x"]], y=aesList[["y"]][yVarNo+1], color=aesList[["color"]],
                    size=aesList[["size"]], shape=aesList[["shape"]], tooltip=aesList[["tooltip"]],
                    data_id=aesList[["data_id"]])

if(!is.na(x=aesList[["y"]][yVarNo+2]))
  gg3 <- renderScatterPlot(x=aesList[["x"]], y=aesList[["y"]][yVarNo+2], color=aesList[["color"]],
                    size=aesList[["size"]], shape=aesList[["shape"]], tooltip=aesList[["tooltip"]],
                    data_id=aesList[["data_id"]])
if(!is.na(x=aesList[["y"]][yVarNo+3]))
  gg4 <- renderScatterPlot(x=aesList[["x"]], y=aesList[["y"]][yVarNo+3], color=aesList[["color"]],
                    size=aesList[["size"]], shape=aesList[["shape"]], tooltip=aesList[["tooltip"]],
                    data_id=aesList[["data_id"]])
