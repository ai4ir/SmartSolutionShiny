...
---------------------------------------------
### **corrplot**
```{r, corrplot, out.height="80%", out.width="80%", fig.height=9, fig.width=15}
if(dim(dfOrg)[1]>1000) {
...
M <- cor(M)
corrplot(M, col=col(3), method = "number",type ="upper", addCoef.col = "red",tl.col = "black", order = "FPC") #order = FPC: 강한 양의상관순으로 배치
